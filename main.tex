...
% Languages
% command to load the appropriate babel package
\newcommand{\documentlanguage}[1]{%
  \ifthenelse{\equal{#1}{en}}{\usepackage[english]{babel}}{}%
  \ifthenelse{\equal{#1}{de}}{\usepackage[ngerman]{babel}}{}%
  \ifthenelse{\equal{#1}{fr}}{\usepackage[french]{babel}}{}%
  \ifthenelse{\equal{#1}{es}}{\usepackage[spanish]{babel}}{}%
  \ifthenelse{\equal{#1}{it}}{\usepackage[italian]{babel}}{}%
  \ifthenelse{\equal{#1}{ru}}{\usepackage[russian]{babel}}{}%
  \ifthenelse{\equal{#1}{pt}}{\usepackage[portuguese]{babel}}{}%
  \ifthenelse{\equal{#1}{nl}}{\usepackage[dutch]{babel}}{}%
  \ifthenelse{\equal{#1}{sv}}{\usepackage[swedish]{babel}}{}%
  \ifthenelse{\equal{#1}{pl}}{\usepackage[polish]{babel}}{}%
  \ifthenelse{\equal{#1}{cs}}{\usepackage[czech]{babel}}{}%
  \ifthenelse{\equal{#1}{hu}}{\usepackage[hungarian]{babel}}{}%
  \ifthenelse{\equal{#1}{el}}{\usepackage[greek]{babel}}{}%
}
